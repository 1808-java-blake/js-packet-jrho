...
console.log(bubbleSort([80,6,2,88,7,9,0]));
...
console.log(reverseStr("JamesRho"));
...
function substring(someStr, length, offset)
{
	...
	{
		console.log("input string is too large.");
		return;
	}
...
traverseObject({"firstName":"James","lastName":"Rho"});
/*10. Delete Element
...
let james = new Person("James Rho",28);
console.log(james);
